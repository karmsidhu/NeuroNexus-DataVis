...
const DATAURL = 'https://gist.githubusercontent.com/karmsidhu/' +
	'c426799449fadfbee22fad8ff3ae83dc/raw/13f1b790974c9bcf603a5' +
	'274c7144028920c0345/AllProvinces-v2.csv';
...
var domElements = {
	...
	radioButton2: document.getElementById('expendVsCaseloads')
};
		...
		var handler = {
			...
			initializeEventListeners: () => {
				...
				domElements.radioButton.addEventListener('change', 
					handler.filterByProvince);
				domElements.radioButton2.addEventListener('change',
					handler.filterByProvince);
			},
			...
			getSelectedFilterType: () => {
				var list = domElements.radioButton2;
				for(var i = 0; i < list.length; i++){
					if(list[i].checked){
						return list[i].defaultValue;
					}	
